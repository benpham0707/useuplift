...
const SCENARIO_2_STAGE2_ISSUE: IssueSuggestion = {
  ...
  suggestions: {
    polished_original: {
      type: 'polished_original',
      text: 'I failed my first physics test—a 47. That night, I took the exam apart question by question, building a spreadsheet of my errors: conceptual gaps here, calculation mistakes there, two questions where I\'d understood the concept but misread the problem entirely. The spreadsheet became my diagnostic tool. Three weeks later, I scored a 94.',
      rationale: 'Transforms devastation into systematic response. The specific score (47) makes it real. The spreadsheet detail shows MIT-valued analytical thinking. Categorizing error types demonstrates metacognition. The turnaround (94) proves the system worked. This isn\'t about the failure—it\'s about the engineer\'s response to failure.',
      what_changed: [
        'Added specific failing score (47) for authenticity',
        'Replaced emotional response with systematic action',
        'Introduced the spreadsheet as a problem-solving tool',
        'Categorized errors to show metacognition',
        'Included the result to demonstrate the method worked',
      ],
      voice_preservation: 'Maintains the honest acknowledgment of failure while pivoting to engineering mindset',
      excellence_alignment: 'Demonstrates systematic problem-solving—MIT\'s core engineering value',
      college_alignment: 'MIT wants makers and problem-solvers who turn setbacks into optimization opportunities',
      score_impact: {
      ...
      when_to_use: 'When you want to emphasize the systematic, analytical approach to problem-solving.',
      safety_level: 'safe',
    } as PolishedOriginalSuggestion,

    voice_amplifier: {
      type: 'voice_amplifier',
      text: 'A 47. I\'d never seen a number like that next to my name. So I did what any reasonable person would do: I built a spreadsheet. Conceptual errors in Column A. Calculation mistakes in Column B. "Understood the concept but completely misread the problem" got its own column because apparently that\'s a thing I do. Three weeks and seventeen practice problems later, I got a 94. The spreadsheet is still on my desktop. I pull it up whenever I need to remember that failure is just undiagnosed opportunity.',
      rationale: 'Uses self-deprecating humor and specific details to show personality alongside problem-solving. The aside ("apparently that\'s a thing I do") shows self-awareness. "Seventeen practice problems" quantifies the effort. The final line ("undiagnosed opportunity") reframes failure with engineer\'s optimism while staying authentic.',
      what_changed: [
        'Added humor and personality ("apparently that\'s a thing I do")',
        'Quantified the recovery effort (seventeen practice problems)',
        'Included ongoing relevance (spreadsheet still on desktop)',
        'Created memorable closing line about failure',
        'Showed both the system AND the person behind it',
      ],
      voice_preservation: 'Amplifies natural analytical personality with self-aware humor',
      excellence_alignment: 'Demonstrates MIT\'s "mens et manus" (mind and hand) through both thinking and doing',
      college_alignment: 'MIT loves students who can laugh at themselves while solving hard problems',
      score_impact: {
        dimension: 'resilience' as any,
        before: 3,
        after: 8,
      ...
      when_to_use: 'When you want to show personality and humor alongside your problem-solving approach.',
      risk_level: 'low',
      why_authentic: 'The self-deprecating humor about "apparently that\'s a thing I do" and the detail about the spreadsheet still being on the desktop—these couldn\'t be invented. This is clearly how this person actually processes setbacks.',
      spark_moments: [
        '"apparently that\'s a thing I do"',
        '"seventeen practice problems later"',
        '"failure is just undiagnosed opportunity"',
      ],
    } as VoiceAmplifierSuggestion,
  },
