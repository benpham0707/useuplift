-- =====================================================
-- FRAUD PREVENTION SYSTEM MIGRATION
...
CREATE TABLE IF NOT EXISTS device_fingerprints (
  ...
  CONSTRAINT fk_user_device FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS essay_analyses (
  ...
  CONSTRAINT fk_user_essay FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS fraud_risk_scores (
  ...
  CONSTRAINT fk_user_risk FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
