...
function getRelevantGuidance(
  ...
  const GUIDANCE_RELEVANCE: Record<string, string[]> = {
    ...
    music: ['studioArtRecommendation', 'artsRecommendation'],
    precalculus: ['precalculusRecommendation'],
    math: ['precalculusRecommendation'],
    mathematics: ['precalculusRecommendation'],
    finance: ['precalculusRecommendation', 'economicsRecommendation'],
    business: ['precalculusRecommendation', 'economicsRecommendation'],
    // R10: Add missing keyword → guidance mappings
    biology: ['biologyRecommendation'],
    bio: ['biologyRecommendation'],
    premed: ['biologyRecommendation'],
    medicine: ['biologyRecommendation'],
    nursing: ['biologyRecommendation'],
    chemistry: ['biologyRecommendation'],
    biochemistry: ['biologyRecommendation'],
    psychology: ['psychologyRecommendation'],
    neuroscience: ['psychologyRecommendation'],
    economics: ['economicsRecommendation'],
    econ: ['economicsRecommendation'],
    history: ['historyComparison'],
    english: ['englishComparison'],
    writing: ['englishComparison'],
    literature: ['englishComparison'],
    humanities: ['englishComparison', 'historyComparison'],
    environmental: ['environmentalScienceRecommendation'],
    performing: ['artsRecommendation'],
    visual: ['studioArtRecommendation'],
    political: ['historyComparison'],
    sociology: ['psychologyRecommendation'],
    education: ['psychologyRecommendation'],
    data: ['csComparison', 'precalculusRecommendation'],
  };
