...
const RECOGNITION_ENTRIES: RecognitionEntry[] = [
  ...
  // ========================================================================
  {
    ...
    aliases: ['congressional app challenge'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'technology',
    subcategory: 'software_development',
    selectivityRatio: '~400 winners from thousands of student submissions',
    scope: 'national',
    context: 'Congressional recognition for software development',
    differentiator: 'Winner vs participant',
    detectionKeywords: ['congressional app challenge'],
  },
  {
    name: 'CyberPatriot National Finalist',
    aliases: ['cyberpatriot national', 'cyberpatriot finalist'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'technology',
    subcategory: 'cybersecurity',
    selectivityRatio: 'Top teams from 5,000+ competing units',
    scope: 'national',
    context: 'Top cybersecurity competition for HS students',
    differentiator: 'National finalist vs state participant',
    detectionKeywords: ['cyberpatriot national', 'cyberpatriot finalist'],
  },
  {
    name: 'FIRST Dean\'s List Award',
    aliases: ['first dean\'s list', 'first deans list'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8.5],
    categoryId: 'technology',
    subcategory: 'robotics',
    selectivityRatio: '~10 finalists per region; top leadership in FIRST',
    scope: 'national',
    context: 'Highest individual honor in FIRST robotics',
    differentiator: 'Dean\'s List vs team award',
    detectionKeywords: ['first dean', 'dean\'s list award', 'first robotics dean'],
  },
  ...
  // ========================================================================
  {
    name: 'Concord Review Published Author',
    aliases: ['concord review author', 'concord review'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'writing_journalism',
    subcategory: 'academic_writing',
    selectivityRatio: '~5% acceptance rate',
    scope: 'national',
    context: 'Only journal publishing HS history papers',
    differentiator: 'Published vs submitted',
    detectionKeywords: ['concord review'],
  },
  {
    name: 'Scholastic Writing Gold Key (National)',
    aliases: ['scholastic writing gold key national', 'scholastic writing national gold'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'writing_journalism',
    subcategory: 'creative_writing',
    selectivityRatio: '~2,000 national awards from 340,000+ submissions',
    scope: 'national',
    context: 'Most prestigious teen writing recognition',
    differentiator: 'Gold Key national vs regional',
    detectionKeywords: ['scholastic writing gold key national', 'scholastic writing national gold'],
  },
  {
    name: 'Columbia Scholastic Press Association Award',
    aliases: ['cspa award', 'columbia scholastic press'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'writing_journalism',
    ...
    selectivityRatio: null,
    scope: 'national',
    context: 'National recognition for student publications',
    differentiator: 'Crown vs medalist',
    detectionKeywords: ['columbia scholastic press', 'cspa'],
  },
  ...
  // ========================================================================
  {
    name: 'Boys/Girls State Delegate',
    aliases: ['boys state delegate', 'girls state delegate'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'leadership_government',
    subcategory: 'civic_leadership',
    selectivityRatio: '~1,000 delegates per state from American Legion selection',
    scope: 'state',
    context: 'Selective civics program run by American Legion',
    differentiator: 'Delegate vs applicant',
    detectionKeywords: ['boys state', 'girls state'],
  },
  {
    name: 'Presidential Scholar Nominee',
    aliases: ['presidential scholar', 'us presidential scholar'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8.5],
    categoryId: 'leadership_government',
    subcategory: 'academic_leadership',
    selectivityRatio: '~5,000 candidates of 3.6M graduating seniors',
    scope: 'national',
    context: 'One of highest honors for graduating HS students',
    differentiator: 'Scholar vs nominee vs candidate',
    detectionKeywords: ['presidential scholar'],
  },
  ...
  // ========================================================================
  {
    ...
    aliases: ['nih summer intern', 'nih internship'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8.5],
    categoryId: 'medical_health',
    subcategory: 'biomedical_research',
    selectivityRatio: '<200 HS students selected nationally',
    scope: 'national',
    context: 'Prestigious government research program',
    differentiator: 'NIH intern vs general hospital volunteer',
    detectionKeywords: ['nih summer', 'nih internship', 'nih intern'],
  },
  {
    name: 'Red Cross Hero Award',
    aliases: ['red cross hero'],
    tier: 3 as InternalTier,
    scoreRange: [5, 6.5],
    categoryId: 'medical_health',
    subcategory: 'emergency_services',
    selectivityRatio: null,
    scope: 'regional',
    context: 'Recognition for exceptional Red Cross service',
    differentiator: 'Hero Award vs volunteer hours',
    detectionKeywords: ['red cross hero'],
  },
  ...
  // ========================================================================
  {
    name: 'Scholastic Art Gold Key (National)',
    aliases: ['scholastic art gold key national', 'scholastic art national gold'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'visual_arts',
    subcategory: 'fine_art',
    selectivityRatio: '~2,000 national awards from 340,000+ submissions',
    scope: 'national',
    context: 'Most prestigious teen art recognition alongside writing',
    differentiator: 'Gold Key national vs regional',
    detectionKeywords: ['scholastic art gold key national', 'scholastic art national gold'],
  },
  {
    name: 'YoungArts Visual Arts Winner',
    aliases: ['youngarts visual arts', 'young arts visual'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'visual_arts',
    subcategory: 'fine_art',
    selectivityRatio: '~150-170 winners from 11,000+ applicants across all arts',
    scope: 'national',
    context: 'Most prestigious HS arts recognition in US',
    differentiator: 'Winner vs finalist vs merit',
    detectionKeywords: ['youngarts visual', 'young arts visual'],
  },
  {
    name: 'AP Art Portfolio Score of 5',
    aliases: ['ap art score 5', 'ap studio art 5'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'visual_arts',
    subcategory: 'fine_art',
    selectivityRatio: null,
    scope: 'national',
    context: 'Top score on demanding portfolio-based AP exam',
    differentiator: 'Score of 5 vs 4 vs 3',
    detectionKeywords: ['ap art portfolio 5', 'ap art score 5', 'ap studio art 5'],
  },
  ...
  // ========================================================================
  {
    ...
    aliases: ['congressional award gold', 'congressional gold medal youth'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'social_activism',
    subcategory: 'civic_engagement',
    selectivityRatio: 'Highest civilian award for youth; requires 400+ hours',
    scope: 'national',
    context: 'Congress\'s highest award for youth achievement',
    differentiator: 'Gold vs Silver vs Bronze',
    detectionKeywords: ['congressional award gold', 'congressional award medal'],
  },
  {
    name: 'JFK Profile in Courage Essay Winner',
    aliases: ['profile in courage winner', 'jfk essay winner'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'social_activism',
    subcategory: 'civic_writing',
    selectivityRatio: '~1 winner from thousands',
    scope: 'national',
    context: 'JFK Library essay competition on political courage',
    differentiator: 'Winner vs finalist',
    detectionKeywords: ['profile in courage', 'jfk essay'],
  },
  {
    name: 'Prudential Spirit of Community Award',
    aliases: ['prudential spirit award', 'spirit of community'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'social_activism',
    subcategory: 'community_impact',
    selectivityRatio: '~100 state honorees + 2 national from tens of thousands',
    scope: 'national',
    context: 'Largest youth recognition program for volunteerism',
    differentiator: 'National vs state vs local',
    detectionKeywords: ['prudential spirit', 'spirit of community'],
  },
  ...
  // ========================================================================
  {
    name: 'Horatio Alger Scholarship Nominee',
    aliases: ['horatio alger scholar', 'horatio alger'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'work_family',
    subcategory: 'resilience',
    selectivityRatio: '106 recipients from tens of thousands of applicants',
    scope: 'national',
    context: 'Recognizes adversity + perseverance + academics',
    differentiator: 'Recipient vs nominee',
    detectionKeywords: ['horatio alger'],
  },
  ...
  // ========================================================================
  {
    name: 'Interfaith Youth Core Recognition',
    aliases: ['ifyc recognition', 'interfaith youth core'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'religious_cultural',
    subcategory: 'interfaith',
    selectivityRatio: null,
    scope: 'national',
    context: 'Recognition for interfaith bridge-building',
    differentiator: 'Selected participant vs general applicant',
    detectionKeywords: ['interfaith youth core', 'ifyc'],
  },
  ...
  // ========================================================================
  {
    ...
    aliases: ['cls scholar', 'critical language scholarship'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'international',
    subcategory: 'language',
    selectivityRatio: '~10% acceptance rate',
    scope: 'national',
    context: 'US State Department intensive language study abroad',
    differentiator: 'CLS scholar vs other study abroad',
    detectionKeywords: ['critical language scholarship', 'cls scholar'],
  },
  {
    name: 'NSLI-Y Scholar',
    aliases: ['nsli-y', 'nsli y scholar'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8.5],
    categoryId: 'international',
    subcategory: 'language',
    selectivityRatio: '~10-15% acceptance for competitive government exchange',
    scope: 'national',
    context: 'State Dept. funded year-long language immersion',
    differentiator: 'NSLI-Y vs general exchange',
    detectionKeywords: ['nsli-y', 'nsli y', 'national security language initiative'],
  },
  {
    name: 'AFS Scholarship Recipient',
    aliases: ['afs scholar', 'afs exchange scholarship'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'international',
    subcategory: 'cultural_exchange',
    selectivityRatio: null,
    scope: 'international',
    context: 'Merit-based scholarship for cultural exchange',
    differentiator: 'Scholarship vs self-funded exchange',
    detectionKeywords: ['afs scholarship', 'afs exchange'],
  },
  ...
  // ========================================================================
  {
    name: 'Shorty Awards Winner',
    aliases: ['shorty award winner', 'shorty awards'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'media_digital',
    subcategory: 'content_creation',
    selectivityRatio: 'Highly competitive; recognizes best social media content',
    scope: 'international',
    context: 'Premier award for social media content creators',
    differentiator: 'Winner vs nominee',
    detectionKeywords: ['shorty award', 'shorty awards'],
  },
  {
    name: 'Webby Award Nominee',
    aliases: ['webby award', 'webby nominee'],
    tier: 1 as InternalTier,
    scoreRange: [9, 10],
    categoryId: 'media_digital',
    subcategory: 'digital_media',
    selectivityRatio: 'Prestigious internet awards from IADAS',
    scope: 'international',
    context: 'Oscar of the internet; recognizes excellence in web content',
    differentiator: 'Nominee vs honoree',
    detectionKeywords: ['webby award', 'webby nominee'],
  },
  {
    name: 'Student Press Law Center Award',
    aliases: ['splc award', 'student press law center'],
    tier: 2 as InternalTier,
    scoreRange: [7, 8],
    categoryId: 'media_digital',
    subcategory: 'student_media',
    selectivityRatio: null,
    scope: 'national',
    context: 'National recognition for student journalism and press freedom',
    differentiator: 'Award winner vs participant',
    detectionKeywords: ['student press law', 'splc award'],
  },
];
