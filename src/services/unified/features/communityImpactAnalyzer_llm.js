...
const COMMUNITY_IMPACT_CONFIG = {
    ...
    writer_prompts: [
        'Who exactly did you help? (Name a person or specific group)',
        'What problem did you see that others ignored?',
        'How is the community different now because of your work?',
        'What will happen to this project when you leave?',
        'How did you get others to join your cause?',
    ],
    warning_signs: [
 ...
 */
export async function analyzeCommunityImpact(essayText) {
...
//# sourceMappingURL=communityImpactAnalyzer_llm.js.map