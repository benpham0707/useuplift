 ...
 */
export async function analyzeRoleClarity(essayText) {
...
**Output Format:**
{
  ...
  "strategic_pivot": "<THE INVISIBLE CEILING: Identify the exact narrative or structural flaw keeping this essay in its current tier. Then prescribe the specific 'counter-factual' action to break through. e.g., 'You say 'we organized the event', which hides your contribution. If you rewrite the middle paragraph to focus on the specific crisis YOU handled with the catering, you move from Passenger to Task Owner.'>",
...
Provide your analysis as JSON following the exact format specified in the system prompt.`;
    try {
        ...
        console.error('[Role Clarity LLM Analyzer] API call failed:', error);
        return {
            score: 0,
            quality_level: 'passenger',
            reasoning: {
...
//# sourceMappingURL=roleClarityAnalyzer_llm.js.map