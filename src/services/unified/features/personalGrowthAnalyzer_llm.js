...
const PERSONAL_GROWTH_CONFIG = {
    ...
    writer_prompts: [
        'What did you think/believe BEFORE this experience?',
        'What was the specific moment that changed your mind?',
        'How are you different today because of this?',
 ...
 */
export async function analyzePersonalGrowth(essayText) {
...
//# sourceMappingURL=personalGrowthAnalyzer_llm.js.map