...
const COHERENCE_CONFIG = {
    ...
    writer_prompts: [
        ...
        'How does the last paragraph connect to the first?',
        'Can you add a transition sentence that links idea A to idea B?',
    ],
    warning_signs: [
        'Topic jumping',
...
// LLM ANALYZER
// ============================================================================
export async function analyzeThematicCoherence(essayText) {
...
//# sourceMappingURL=thematicCoherenceAnalyzer_llm.js.map