...
const INTELLECTUAL_VITALITY_CONFIG = {
    ...
    writer_prompts: [
        'What topic do you get lost in for hours?',
        'What book/article/podcast changed how you think about X?',
        'What is a question you are still trying to answer?',
        'How have you explored this interest outside of school?',
        'What is the most surprising thing you learned about this?',
    ],
    warning_signs: [
 ...
 */
export async function analyzeIntellectualVitality(essayText) {
...
//# sourceMappingURL=intellectualVitalityAnalyzer_llm.js.map