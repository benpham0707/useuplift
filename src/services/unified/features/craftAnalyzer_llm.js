...
const CRAFT_CONFIG = {
    ...
    writer_prompts: [
        'Circle all the "to be" verbs (is, was, were). Can you replace them with action verbs?',
        'Read your essay aloud. Where do you stumble? Fix the rhythm there.',
        'Find a cliché (e.g., "hard work pays off"). Rewrite it using a specific image.',
    ],
    warning_signs: [
...
// LLM ANALYZER
// ============================================================================
export async function analyzeCraft(essayText) {
...
//# sourceMappingURL=craftAnalyzer_llm.js.map