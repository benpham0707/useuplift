...
export class EssayOrchestrator {
    ...
    static async analyzeEssay(text, promptType, profile) {
        ...
        // Await Universal
        const [voiceResult, craftResult, specificityResult, narrativeArcResult, thematicResult, hookResult, vulnerabilityResult] = await Promise.all([
     ...
     */
    static mapPromptTypeToHookType(promptType) {
        const map = {
     ...
     */
    static getRouteForPrompt(text, promptType) {
        const primary = {};
        const secondary = {};
        switch (promptType) {
...
//# sourceMappingURL=essayOrchestrator.js.map