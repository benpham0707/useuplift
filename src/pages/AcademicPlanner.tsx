      ...
      <div className="gradient-dashboard text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-card shadow-game hover:shadow-strong hover:scale-110 transition-all duration-500 rounded-xl p-4 border border-primary/10 animate-[float-elegant_6s_ease-in-out_infinite] hover:animate-[pulse-glow_2s_ease-in-out_infinite]">
            ...
            <div className="bg-card shadow-game hover:shadow-strong hover:scale-110 transition-all duration-500 rounded-xl p-4 border border-primary/10 animate-[float-elegant_6s_ease-in-out_infinite_1s] hover:animate-[pulse-glow_2s_ease-in-out_infinite]">
              <div className="text-2xl font-bold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
                {currentGPA.unweighted}
              </div>
              <div className="text-sm text-muted-foreground font-medium">Unweighted GPA</div>
            </div>
            <div className="bg-card shadow-game hover:shadow-strong hover:scale-110 transition-all duration-500 rounded-xl p-4 border border-primary/10 animate-[float-elegant_6s_ease-in-out_infinite_2s] hover:animate-[pulse-glow_2s_ease-in-out_infinite]">
              <div className="text-2xl font-bold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
            ...
            <div className="bg-card shadow-game hover:shadow-strong hover:scale-110 transition-all duration-500 rounded-xl p-4 border border-primary/10 animate-[float-elegant_6s_ease-in-out_infinite_3s] hover:animate-[pulse-glow_2s_ease-in-out_infinite]">
              <div className="text-2xl font-bold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
